...
class ConverterWindow(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.title("RGB AND CMYK Converter")
        ...
        self.upper_frame = tk.Frame(self, width=800, height=400, bg="lightblue")
        self.upper_frame.pack(side=tk.TOP, fill=tk.BOTH)
        self.upper_frame.pack_propagate(False)
        
        self.lower_frame = tk.Frame(self, width=800, height=400, bg="white")
